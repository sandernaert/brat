...
from annotator_cachen import create_arc, delete_arc, reverse_arc
from annotator_cachen import create_span, delete_span
from annotator_cachen import split_span
from ApplicationScope import getDocJson
...
from projectconfig import get_all_types
from folia2brat import convert
from textannotations import select, get_list, unselect,get_startlist, input_text
...
DISPATCHER = {
        ...
        #Added by sander, getAnnObject uses caching
        'getDocument': getDocJson,
        #'getDocument': getAnnObject,
        ...
        'convertFolia': convert,
        'getAllTypes' : get_all_types,
        'selectList' : select,
        'getStartList' : get_startlist,
        'previousList' : unselect,
