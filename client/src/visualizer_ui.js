...
//         hideNoDocMessage();
      ...
      /* END data dialog - related */
	   ...
	   // Added by sander Naert, Visible Layers
...
//       };
	...
	var configurationChangedUpdate = function() {
        //this function will also reload and redraw the svg.
        invalidateSavedSVG();
      ...
      dispatcher.
          ...
          on('configurationChangedWithUpdate', configurationChangedUpdate).
          //added by sander naert
